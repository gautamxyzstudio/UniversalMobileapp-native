...
export const provincesAndCities: IFilterSheet[] = [
  {
    ...
    value: [
      {id: 1, subTitle: 'Toronto'},
      {id: 2, subTitle: 'Vancouver'},
      {id: 3, subTitle: 'Montreal'},
      {id: 4, subTitle: 'Calgary'},
      {id: 5, subTitle: 'Ottawa'},
    ],
  },
  {
    id: 1,
    title: 'Alberta',
    value: [
      {id: 6, subTitle: 'Calgary'},
      {id: 7, subTitle: 'Edmonton'},
      {id: 8, subTitle: 'Red Deer'},
      {id: 9, subTitle: 'Lethbridge'},
      {id: 10, subTitle: 'St. Albert'},
    ],
  },
  {
    id: 7,
    ...
    value: [
      {id: 11, subTitle: 'Vancouver'},
      {id: 12, subTitle: 'Victoria'},
      {id: 13, subTitle: 'Surrey'},
      {id: 14, subTitle: 'Burnaby'},
      {id: 15, subTitle: 'Richmond'},
    ],
  },
  {
    id: 13,
    title: 'Manitoba',
    value: [
      {id: 16, subTitle: 'Winnipeg'},
      {id: 17, subTitle: 'Brandon'},
      {id: 18, subTitle: 'Steinbach'},
      {id: 19, subTitle: 'Thompson'},
      {id: 20, subTitle: 'Portage la Prairie'},
    ],
  },
  {
    id: 19,
    title: 'New Brunswick',
    value: [
      {id: 21, subTitle: 'Fredericton'},
      {id: 22, subTitle: 'Moncton'},
      {id: 23, subTitle: 'Saint John'},
      {id: 24, subTitle: 'Miramichi'},
      {id: 25, subTitle: 'Bathurst'},
    ],
  },
  {
    id: 25,
    ...
    value: [
      {id: 26, subTitle: "St. John's"},
      {id: 27, subTitle: 'Mount Pearl'},
      {id: 28, subTitle: 'Corner Brook'},
      {id: 29, subTitle: 'Gander'},
      {id: 30, subTitle: 'Grand Falls-Windsor'},
    ],
  },
  {
    id: 31,
    title: 'Nova Scotia',
    value: [
      {id: 32, subTitle: 'Halifax'},
      {id: 33, subTitle: 'Sydney'},
      {id: 34, subTitle: 'Truro'},
      {id: 35, subTitle: 'New Glasgow'},
      {id: 36, subTitle: 'Glace Bay'},
    ],
  },
  {
    id: 37,
    title: 'Ontario',
    value: [
      {id: 38, subTitle: 'Toronto'},
      {id: 39, subTitle: 'Ottawa'},
      {id: 40, subTitle: 'Mississauga'},
      {id: 41, subTitle: 'Brampton'},
      {id: 42, subTitle: 'Hamilton'},
    ],
  },
  {
    id: 43,
    ...
    value: [
      {id: 44, subTitle: 'Charlottetown'},
      {id: 45, subTitle: 'Summerside'},
      {id: 46, subTitle: 'Stratford'},
      {id: 47, subTitle: 'Cornwall'},
    ],
  },
  {
    id: 48,
    title: 'Quebec',
    value: [
      {id: 49, subTitle: 'Montreal'},
      {id: 50, subTitle: 'Quebec City'},
      {id: 51, subTitle: 'Laval'},
      {id: 52, subTitle: 'Gatineau'},
      {id: 53, subTitle: 'Longueuil'},
    ],
  },
  {
    id: 54,
    title: 'Saskatchewan',
    value: [
      {id: 55, subTitle: 'Saskatoon'},
      {id: 56, subTitle: 'Regina'},
      {id: 57, subTitle: 'Prince Albert'},
      {id: 58, subTitle: 'Moose Jaw'},
      {id: 59, subTitle: 'Yorkton'},
    ],
  },
  {
    id: 60,
    ...
    value: [
      {id: 61, subTitle: 'Yellowknife'},
      {id: 62, subTitle: 'Hay River'},
      {id: 63, subTitle: 'Inuvik'},
      {id: 64, subTitle: 'Fort Smith'},
      {id: 65, subTitle: 'Behchokǫ̀'},
    ],
  },
  {
    id: 66,
    title: 'Nunavut',
    value: [
      {id: 67, subTitle: 'Iqaluit'},
      {id: 68, subTitle: 'Rankin Inlet'},
      {id: 69, subTitle: 'Arviat'},
      {id: 70, subTitle: 'Baker Lake'},
      {id: 71, subTitle: 'Pond Inlet'},
    ],
  },
  {
    id: 72,
    title: 'Yukon',
    value: [
      {id: 73, subTitle: 'Whitehorse'},
      {id: 74, subTitle: 'Dawson City'},
      {id: 75, subTitle: 'Watson Lake'},
      {id: 76, subTitle: 'Haines Junction'},
      {id: 77, subTitle: 'Carcross'},
    ],
  },
];
